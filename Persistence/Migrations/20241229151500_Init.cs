        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalOpinion = table.Column<int>(type: "int", nullable: false),
                    MostViewedCategory = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MostViewedCity = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SessionFavoritePosts", x => new { x.SessionId, x.PostId });
                    table.ForeignKey(
                        name: "FK_SessionFavoritePosts_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SessionFavoritePosts_Sessions_SessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionFavoritePosts_PostId",
                table: "SessionFavoritePosts",
                column: "PostId");
