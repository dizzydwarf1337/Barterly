...
namespace Application.Features.Posts.Events.PostOpinionCreatedEvent
{
    public class PostOpinionCreatedEventHandler : INotificationHandler<PostOpinionCreatedEvent>
    {
        ...
        public PostOpinionCreatedEventHandler(IMailService mailService, INotificationCommandRepository notificationCommandRepository, IPostQueryRepository postQueryRepository, IUserQueryRepository userQueryRepository)
        {
        ...
        {
            var post = await _postQueryRepository.GetPostById(notification.PostOpinion.PostId,role:"Admin");
            ...
            var user = await _userQueryRepository.GetUserAsync(notification.PostOpinion.AuthorId);
            var postOwner = await _userQueryRepository.GetUserAsync(post.OwnerId);
