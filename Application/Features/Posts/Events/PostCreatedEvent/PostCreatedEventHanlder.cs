...
namespace Application.Features.Posts.Events.PostCreatedEvent
{
    public class PostCreatedEventHanlder : INotificationHandler<PostCreatedEvent>
    {
        ...
        public PostCreatedEventHanlder(IPostQueryRepository postQueryRepository, IUserQueryRepository userQueryRepository, IMailService mailService, INotificationCommandRepository notificationCommandRepository)
        {
        ...
        public async Task Handle(PostCreatedEvent notification, CancellationToken cancellationToken)
        {
            ...
            var post = await _postQueryRepository.GetPostById(notification.PostId,notification.UserId,"Admin");
