...
namespace Application.Features.Posts.Events.PostApprovedEvent
{
    public class PostApprovedEventHandler : INotificationHandler<PostApprovedEvent>
    {
        ...
        public PostApprovedEventHandler(IPostQueryRepository postQueryRepository, IUserQueryRepository userQueryRepository, IMailService mailService, INotificationCommandRepository notificationCommandRepository)
        {
