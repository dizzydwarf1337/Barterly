...
namespace Application.Features.Posts.Events.PostRejectedEvent
{
    public class PostRejectedEventHandler : INotificationHandler<PostRejectedEvent>
    {
        ...
        public PostRejectedEventHandler(IPostQueryRepository postQueryRepository, IUserQueryRepository userQueryRepository, IMailService mailService, INotificationCommandRepository notificationCommandRepository)
        {
        ...
        public async Task Handle(PostRejectedEvent notification, CancellationToken cancellationToken)
        {
            ...
            var post = await _postQueryRepository.GetPostById(Guid.Parse(notification.postId),null,"Admin");
