...
namespace Application.Features.Users.Events.EmailConfirmed
{
    public class EmailConfirmedEventHandler :INotificationHandler<EmailConfirmedEvent>
    {
        ...
        public EmailConfirmedEventHandler(IMailService mailService, INotificationCommandRepository notificationCommandRepository, IUserQueryRepository userQueryRepository)
        {
