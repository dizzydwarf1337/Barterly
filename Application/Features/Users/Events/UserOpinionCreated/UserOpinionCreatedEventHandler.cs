...
namespace Application.Features.Users.Events.UserOpinionCreated
{
    public class UserOpinionCreatedEventHandler : INotificationHandler<UserOpinionCreatedEvent>
    {
        ...
        public UserOpinionCreatedEventHandler(IMailService mailService, INotificationCommandRepository notificationCommandRepository, IUserQueryRepository userQueryRepository)
        {
        ...
        public async Task Handle(UserOpinionCreatedEvent notification, CancellationToken cancellationToken)
        {
            ...
            var user = await _userQueryRepository.GetUserAsync(notification.opinion.AuthorId);
            var opinionReceiver = await _userQueryRepository.GetUserAsync(notification.opinion.UserId);
