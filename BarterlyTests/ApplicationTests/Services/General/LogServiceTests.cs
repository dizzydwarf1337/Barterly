...
public class LogServiceTests
{
    ...
    public async Task CreateLogAsync_WithParams_ShouldCallCreateLogAsync()
    {
        ...
        // Assert
        _logCommandRepoMock.Verify(
            r => r.CreateLogAsync(It.Is<Log>(l => l.Message == message && l.LogType == logType)), Times.Once);
    }
    ...
    public async Task GetLogsPaginatedAsync_ShouldReturnMappedLogs()
    {
        ...
        {
            new() { Message = "Log1", LogType = LogType.None },
            new() { Message = "Log2", LogType = LogType.Warning }
        };
    ...
    public async Task GetPostLogsAsync_ShouldReturnMappedLogs()
    {
        ...
        var logs = new List<Log> { new() { PostId = postId, Message = "Post log" } };
        var logDtos = new List<LogDto> { new() { Message = "Post log" } };
    ...
    public async Task GetUserLogsAsync_ShouldReturnMappedLogs()
    {
        ...
        var logs = new List<Log> { new() { UserId = userId, Message = "User log" } };
        var logDtos = new List<LogDto> { new() { Message = "User log" } };
