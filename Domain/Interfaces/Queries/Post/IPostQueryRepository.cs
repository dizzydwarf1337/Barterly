namespace Domain.Interfaces.Queries.Post
{
    ...
    {
        Task<Entities.Posts.Post> GetPostById(Guid postId, Guid? userId = null, string? role = "User");
        Task<ICollection<Entities.Posts.Post>> GetPostsByOwnerIdPaginated(Guid ownerId, int pageCount, int page, Guid? currentUserId = null, string? role = "User");
