...
export default observer(function ProfileSettingsMenu() { 
    ...
    return (
        <Menu 
            ...
            onClose={() => {
                uiStore.setUserSettingIsOpen(false); uiStore.setMenuElement(undefined)
            }}
            transitionDuration={400}
        >
            <Box sx={{ p: "10px", height:"100%" }} display="flex" flexDirection="column" gap="5px" justifyContent="center" alignItems="center">
