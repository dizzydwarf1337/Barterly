                ...
                <Box display="flex" width="100%" height="100%" sx={{backgroundColor: "primary.main"}}>
                    <Box display="flex" flexDirection="column" width="100%" p="10px" m="10px">
                        <Box display="flex" flexDirection="row" justifyContent="flex-end" alignItems="center"
                             height="50px" sx={{backgroundColor: "primary."}} width="100%">
                            <IconButton onClick={() => setIsMobileMenuOpen(false)}>
                                <CloseIcon color="error"/>
                            </IconButton>
                        </Box>
                        <Box display="flex" flexDirection="column" justifyContent="" alignItems="center" width="100%"
                             gap="30px">
                            <Box width="100%">
                            ...
                            <Box sx={{
                                ...
                                <Button onClick={uiStore.changeLanguage}>
                                    <Typography variant="button"
                                                color="secondary"> {i18n.language === 'en' ? 'PL' : 'EN'} </Typography>
                                </Button>
                            </Box>
                        </Box>
                    </Box>
