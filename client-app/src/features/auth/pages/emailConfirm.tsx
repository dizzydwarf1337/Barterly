...
export const EmailConfirm = () => {
  ...
  const handleResendEmail = async () => {
    ...
    try {
      if (email) {
        await authApi.resendEmailConfirm({ Email: email });
          ...
          >
            ...
            >
              <Typography variant="body2" sx={{ lineHeight: 1.6 }}>
                {t("emailConfirmationPostRegister")}
              </Typography>
            </Alert>
            ...
            {emailSentCount > 0 && (
              <Box mb={3}>
                <Typography variant="body2" color="text.secondary">
                  {t("confirmationMailSent", { count: emailSentCount + 1 })}
                </Typography>
              </Box>
            )}
              ...
              {resendTime > 0 && (
                <Box mb={2}>
                  ...
                  >
                    ...
                    <Typography variant="body2" color="text.secondary">
                      {t("sendAgain")} {formatTime(resendTime)}
                    </Typography>
                  </Box>
                  <LinearProgress
                    variant="determinate"
