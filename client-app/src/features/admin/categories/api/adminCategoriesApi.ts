...
import { AddCategoryRequestDto, GetAllCategoriesRequestDto, GetAllCategoriesResponseDto, UpdateCategoryRequestDto } from "../dto/categoriesDto";


const categoriesApi = {
     getCategories: (request?: GetAllCategoriesRequestDto) =>
        apiClient.post<ApiResponse<GetAllCategoriesResponseDto>>("admin/categories", request || {
            filterBy: {
                pageNumber: 1,
                pageSize: 10
            },
